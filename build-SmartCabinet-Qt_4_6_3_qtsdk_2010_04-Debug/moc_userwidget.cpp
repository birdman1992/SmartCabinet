...
**
** Created: Mon May 8 11:01:13 2017
**      by: The Qt Meta Object Compiler version 62 (Qt 4.6.3)
**
** WARNING! All changes made in this file will be lost!
*****************************************************************************/

#include "../SmartCabinet/Widgets/userwidget.h"
...
static const char qt_meta_stringdata_UserWidget[] = {
    "UserWidget\0\0index\0winSwitch(int)\0"
    "recvUserInfo(QByteArray)\0updateUserList()\0"
    "on_addUser_clicked()\0on_addOk_clicked()\0"
};

const QMetaObject UserWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_UserWidget,
      qt_meta_data_UserWidget, 0 }
};
...
int UserWidget::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: recvUserInfo((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        case 2: updateUserList(); break;
        case 3: on_addUser_clicked(); break;
        case 4: on_addOk_clicked(); break;
        default: ;
        }
        _id -= 5;
    }
...
// SIGNAL 0
void UserWidget::winSwitch(int _t1)
{
